...
public class AccountManager {
    ...
    public void applyInterests() {
        ...
        double fee = config.getPropertyAsDouble("yearly.interest.rate");
        
        for (Account acc : accounts) {
            double interest = acc.getBalance() * (fee);
    ...
    public void chargeBusinessFees() {
        ...
        ConfigManager config = ConfigManager.getInstance();
        double monthlyFee = config.getPropertyAsDouble("busness.fee.monthly");
