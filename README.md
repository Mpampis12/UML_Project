...
- **🖥️ Γραφικό Περιβάλλον (GUI):** Φιλικό προς τον χρήστη περιβάλλον, χτισμένο με **Java Swing** (Dashboards, Πίνακες Ιστορικού, Κάρτες Συναλλαγών).
- **🗄️ Αποθήκευση Δεδομένων:** Τοπική αποθήκευση σε μορφή JSON (`Database.json`) με τη χρήση της βιβλιοθήκης **Gson**.

---

## 🏗️ Αρχιτεκτονική & Design Patterns
