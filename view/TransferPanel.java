...
public class TransferPanel extends JPanel {
    ...
    List<AccountSelectionCard> cardList = new ArrayList<>();
    ...
    for (Account acc : accounts) {
        AccountSelectionCard card = new AccountSelectionCard(acc, selectedAccount -> {
            ...
            for (AccountSelectionCard c : cardList) {
                if (c.getAccount().equals(selectedAccount)) {
                    c.setSelected(true);
                } else {
                    c.setSelected(false);
                }
    ...
    // RIGHT: Form (Κώδικας ίδιος με πριν, προσαρμοσμένος στη δομή)
    ...
    sub.insets = new Insets(5, 0, 5, 0); 
    sub.gridx = 0; sub.gridy = 0;
    ...
    contBtn.addActionListener(e -> {
        ...
        // Άμεση εκτέλεση για απλούς τύπους (Withdraw/Deposit)
        ...
        // Προετοιμασία κειμένου επιβεβαίωσης για τα υπόλοιπα
        ...
        if(type.equals("TRANSFER")) {
            ...
            sb.append("RF: ").append(fTarget.getText());
        }
